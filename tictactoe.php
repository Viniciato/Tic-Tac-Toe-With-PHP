...
<?php require_once "implements.php" ?>

<div class="col-lg-12">
      <span class='help-block alert-success'><?= @$ganhador=="1" ?" O Jogador $jogador Venceu!" :""; ?></span>
      <span class='help-block alert-success'><?= @$ganhador=="2" ?" O Jogo empatou" :""; ?></span>
      <form method="POST"><input type="submit" value="Novo Jogo" name="new" id="new" class="btn btn-lg btn-primary"></form>
      <h5>Jogador Atual: <?= $jogador; ?></h3>
      <form method="POST">
        <table class="velha">
          <tr>
